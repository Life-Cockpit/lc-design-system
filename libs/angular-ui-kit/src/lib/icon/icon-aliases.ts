...
export const ICON_ALIASES: Readonly<Record<string, string>> = {
  ...
  'puzzle-piece': 'puzzle',
  'paper-airplane': 'send',
  'presentation-chart-bar': 'presentation-analytics',
  'chat-bubble-left': 'message-circle',
  'chat-bubble-left-right': 'messages',
  'building-office': 'building',
  'rocket-launch': 'rocket',
  // Heroicon's logout arrow — v2 name plus the v1 spelling still in the wild.
  'arrow-right-start-on-rectangle': 'logout',
